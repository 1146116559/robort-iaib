...
def Intersection(img, lines_data, Horizontal, vertical, check_x, check_y, serial):
...
while True:
    while arduino.in_waiting:
        try:
            ser_data_raw = arduino.readline()
            ser_data = data_raw.decode()
            ...
            if Lines is not None:
                ...
                result = Intersection(new_img, data, Horizontal, vertical, check_x, check_y, ser_data)
